...
**SecureSME** is a secure, full stack platform designed to maintain the chain of custody for digital forensic evidence. It features an automated ** Threat Intelligence Engine ** that parses raw server logs to detect brute-force attacks and privilege ascalation in real-time.
...
graph TD
    ...
    Engine -->|Parse and Detect| Rules[Regex Threat Signatures]
...
* **Automated Threat Detection:** Parses unstructured server logs (, ) to identify high-severity incidents like SSH brute force and Root access attempts.
